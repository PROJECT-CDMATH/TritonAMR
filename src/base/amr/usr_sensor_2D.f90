...
!                                                                                     *
! SYNTAXE SUBROUTINE:  subroutine usr_sensor_2D(l,n)                                  *
!     l : numero du patch                                                             *
!     n : nombre de cellules flagees      	                                      *
!                                                                                     *
!**************************************************************************************

subroutine usr_sensor_2D(l,n)
...
!!!!!!!!!!!!! DEBUT DE DECLARATIONS DE VARIABLES LOCALES !!!!!!!!!!!!!!!!
	...
	integer :: m, im, ijk, ibmp, jbmp, kbmp, ijk0, i, j, k, isensor1 

	DOUBLE PRECISION :: eps, gradx_YY, grady_YY, grad_max_YY, sensor1
...
!!!!!!!!!!!!! FIN DE DECLARATIONS DE VARIABLES LOCALES !!!!!!!!!!!!!!!!     
	...
	do m = 1, nga(l)
		...
		do j = 1,jmx(im)	    
			...
			do i = 1,imx(im)
				...
				grad_max_YY = max(grad_max_YY,abs(gradx_YY)+abs(grady_YY))
	...
	do m = 1, nga(l)
		...
		do j = 1,jmx(im)
			...
			sensor1 = (abs(gradx_YY )+abs(grady_YY ))/grad_max_YY
