...
! calcul des dimensions du patch coarse sous-jacent
				...
				call solver_vfin_cgradg(isit(l),3,ri(l),rj(l),rk(l), &
...
! calcul des dimensions du patch coarse sous-jacent
				...
				call solver_vfin_cgradg(isit(l),4,ri(l),rj(l),rk(l), &
					 hqptr(mc),ijkc,m1c,m2c,m3c, &
					 ijkf,m1f,m2f,m3f, &
					 la,la,neqt,ighc, &
					 q,q)
...
! calcul des dimensions du patch coarse sous-jacent
				...
				call solver_vfin_cgradg(isit(l),1,ri(l),rj(l),rk(l), &
					 hqptr(mc),ijkc,m1c,m2c,m3c, &
					 ijkf,m1f,m2f,m3f, &
					 la,la,neqt,ighc, &
					 q,q)
...
! calcul des dimensions du patch coarse sous-jacent
				...
				call solver_vfin_cgradg(isit(l),2,ri(l),rj(l),rk(l), &
					 hqptr(mc),ijkc,m1c,m2c,m3c, &
					 ijkf,m1f,m2f,m3f, &
					 la,la,neqt,ighc, &
					 q,q)
...
! calcul des dimensions du patch coarse sous-jacent
				...
				call solver_vfin_cgradg(isit(l),5,ri(l),rj(l),rk(l), &
					 hqptr(mc),ijkc,m1c,m2c,m3c, &
					 ijkf,m1f,m2f,m3f, &
					 la,la,neqt,ighc, &
					 q,q)
...
!! calcul des dimensions du patch coarse sous-jacent
				...
				call solver_vfin_cgradg(isit(l),6,ri(l),rj(l),rk(l), &
					 hqptr(mc),ijkc,m1c,m2c,m3c, &
					 ijkf,m1f,m2f,m3f, &
					 la,la,neqt,ighc, &
					 q,q)
