...
!                                                                                           *
! SYNTAXE SUBROUTINE:  subroutine  F_EXEC_LAGOUTIERE                                        *
!                                                                                           *
!											    *
!********************************************************************************************

subroutine F_EXEC_LAGOUTIERE
...
! ==========================================
	   ...
	   if (directions_alternees==0) then
           	...
           	call calcul_decentre_aval_sous_contraintes_des_flux_de_Y_1_x

           	call calcul_decentre_aval_sous_contraintes_des_flux_de_Y_1_y

           	if(dir(1).eq.3) call calcul_decentre_aval_sous_contraintes_des_flux_de_Y_1_z
		...
		if(TYPE_DIR.eq.1) then
			...
			call calcul_decentre_aval_sous_contraintes_des_flux_de_Y_1_z  !m
...
end  subroutine F_EXEC_LAGOUTIERE
